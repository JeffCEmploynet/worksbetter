...
export default function AddOrderModal({customerId, customerName, branch, show, onHide}:
  {customerId: Number, customerName: String, branch: String, show: any, onHide: any}){
  return(
    <Modal onShow={show} onHide={onHide}>
